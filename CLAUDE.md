...
| 話し言葉（声と話し方） | `voice-archive/`（話し言葉 226件の地図 `speech_map.tsv` ＋ 機械集計 `features.md` ＋ **話し方プロファイル `speech_profile.md`**） | Claude Code / ChatGPT への**音声入力**とボイスメモ文字起こしをフィラーで判定して抽出（**本人口調で書くときに読む**） |
