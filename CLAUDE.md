...
7. **壁打ちの結論は「なんでもメモ」へ残す（記載前に必ず確認）。** 相談・議論・思考整理・意思決定・アイデア出しをして、あとで見返す価値のある結論・気づき・決定・ネタが出たら、そのやり取りの締めで **「なんでもメモに記載しますか？」とオーナーに質問**し、承認を得てから、その日の「今日やること - YYYY年M月D日」ノートの **なんでもメモ** 欄へ要約を記載する。**質問せずに勝手に書き込まない。** 迷ったら（残す価値があるか判断に迷うくらいなら）オファー側に倒す。手順は [braindump-to-memo スキル](.claude/skills/braindump-to-memo/SKILL.md)。
